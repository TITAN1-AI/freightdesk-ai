// Adapted from extensions/ascend-x1/load-board-view.js. Observation only; no native host.
(() => {
  'use strict';
  ...
  globalThis.FreightDeskPortableBoardView=Object.freeze({observe,watch,classify});
})();
