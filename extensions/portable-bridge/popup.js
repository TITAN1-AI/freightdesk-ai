...
function writeBanner(write) {
  ...
  return ({
    ...
    typed_but_not_saved: 'Private Load Note already has the text, but Save / Save & Exit was not clicked. Reload unpacked 0.1.6 and retry with whole-form approval.',
    ...
    BRIDGE_CLAIM_TIMEOUT: 'Bridge did not claim the write in time. Reload unpacked 0.1.6, keep the popup open, and retry.',
